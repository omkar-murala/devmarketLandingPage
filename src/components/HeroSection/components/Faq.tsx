    ...
    <section className="mx-auto max-w-7xl px-2 py-10 md:px-0">
      <div>
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          A smooth deployment process can be achieved by conducting comprehensive testing, automating the deployment steps, and preparing a contingency plan for any potential issues.
          </p>
        </div>
        <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16">
          <div className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200">
            ...
            <div className="px-4 pb-5 sm:px-6 sm:pb-6">
              ...
              You can contact our customer support via a email
              </p>
            </div>
          </div>
