      ...
      <div className="relative mx-auto max-w-7xl px-4">
        <div className="mx-auto mb-24 max-w-2xl text-center lg:max-w-5xl">
          <h1 className="mb-8 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
            Make you business online
          </h1>
          <p className="text-lg text-gray-500">
            
To deploy an application smoothly without any issues, ensure thorough testing, use reliable deployment tools, and have a solid rollback plan in place.
          </p>
        </div>
